      ...
      BottomNavigationBar(
        ...
        items: <BottomNavigationBarItem>[
          ...
          BottomNavigationBarItem(
            ...
            title: Text("TopLef", style: TextStyle(color: Colors.pink)),
          ),
          BottomNavigationBarItem(
            icon: Icon(Icons.call_made),
            title: Text("TopRig", style: TextStyle(color: Colors.brown)),
          ),
          BottomNavigationBarItem(
            icon: Icon(Icons.call_received),
            title: Text("BotLef", style: TextStyle(color: Colors.amber)),
          ),
          BottomNavigationBarItem(
            icon: Icon(Icons.fitness_center),
            title: Text("BotRigh", style: TextStyle(color: Colors.red)),
          ),
          BottomNavigationBarItem(
            icon: Icon(Icons.arrow_downward),
            title: Text("BotCen", style: TextStyle(color: Colors.red)),
          ),
        ],
        onTap: _function,
